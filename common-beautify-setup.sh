...
cd $BEAUTIFY_DIR
mkdir -p $BEAUTIFY_DIR/font $BEAUTIFY_DIR/grub $BEAUTIFY_DIR/icon
...
curl -o JuliaMono.tar.gz -sSL https://github.com/cormullion/juliamono/releases/download/v0.054/JuliaMono.tar.gz
...
mkdir -p $HOME/.local/share/fonts/Hasklig-Nerd && tar -Jxf Hasklig.tar.xz -C $HOME/.local/share/fonts/Hasklig-Nerd
